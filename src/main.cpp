...
void setup()
{
  ...
  GET_home();
  // mutiTask
  xTaskCreatePinnedToCore(pin_c, "buttons", 10240, NULL, 1, NULL, 1);
  xTaskCreatePinnedToCore(servo_door_open, "open", 10240, NULL, 2, NULL, 1);
  xTaskCreatePinnedToCore(servo_door_close, "close", 10240, NULL, 2, NULL, 1);
  xTaskCreatePinnedToCore(time_count, "timer", 10240, NULL, 2, NULL, 1);
  //xTaskCreatePinnedToCore(obstacle, "LDR&laser", 1024, NULL, 2, NULL, 1);
